...
* The Home Office Security app is not compatible with the Android Auto app on Android devices.
* Safari Advanced Tracking and fingerprinting protection in case of blocking fallbacks to the proprietary Safari resolver. To resolve this limitation go to: "Safari" -> "Settings" -> "Advanced" -> "Advanced Tracking and Fingerprinting Protection" -> "turn-off" 
